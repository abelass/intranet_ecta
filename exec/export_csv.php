...
while($r = spip_fetch_array($q)) {
	...
	ecta_members.pastpresident, ecta_members.active, ecta_members.vat_number, ecta_members.countrytype, ecta_members.councilmem, mem_coms  FROM ecta_members $where");
